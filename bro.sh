...
function install_prereqs {
    yum install -q -y git cmake cmake28 make gcc gcc-c++ flex bison libpcap-devel openssl-devel python-devel swig gperftools-devel GeoIP-devel || die "prereqs failed"
}
